...
def extract(a, t, x_shape):
    b, *_ = t.shape
    out = a.gather(-1, t)  # 按照时间索引返回 根下alpha_t
    t = out.reshape(b, *((1,) * (len(x_shape) - 1))) # 重塑成 len(x_shape) 维的向量 ， 这里不reshape也可以直接使用吧
    return t
...
if __name__ == '__main__':
    dm = GaussianDiffusion('model', (64, 64), 3, None, torch.randint(0, 10, size=(10,)))
    dm(torch.rand(16, 3, 64, 64))